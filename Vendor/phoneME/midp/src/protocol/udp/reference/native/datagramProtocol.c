...
static jfieldID datagramNativeHandleField;
static int datagramFieldsInitialized;

#define DATAGRAM_GET_HANDLE(object) \
    KNI_GetIntField((object), datagramNativeHandleField)
#define DATAGRAM_SET_HANDLE(object, value) \
    KNI_SetIntField((object), datagramNativeHandleField, \
                    (jint)(intptr_t)(value))
#define DATAGRAM_HANDLE(value) ((void*)(intptr_t)(jint)(value))
...
Java_com_sun_midp_io_j2me_datagram_Protocol_open0(void) {
    ...
    if (tryOpen) {
        ...
        if (pushReturn == -1) {
            ...
            DATAGRAM_SET_HANDLE(thisObject, pushReturn);
            tryOpen = KNI_FALSE;
        }
    }
...
Java_com_sun_midp_io_j2me_datagram_Protocol_send0(void) {
    ...
    socketHandle = DATAGRAM_HANDLE(DATAGRAM_GET_HANDLE(thisObject));
