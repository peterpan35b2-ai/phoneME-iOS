...
/**
 * Stable 32-bit native IDs used by the Java platform-widget peers.
 *
 * The original implementation cast C pointers to jint. That truncates
 * pointers on arm64. The registry keeps pointers native-sized and exposes
 * small integer handles to Java and to the iOS native-UI bridge.
 */
