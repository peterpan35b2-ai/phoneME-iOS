...
Java_javax_microedition_lcdui_AlertLFImpl_showNativeResource0() {
    ...
    /* Get parameters */
    MidpDisplayable *alertPtr = MidpDisplayableFromId(
...
Java_javax_microedition_lcdui_AlertLFImpl_setNativeContents0() {
    ...
    jboolean isContentScroll = KNI_FALSE;
    int gaugeBounds[4];
    int *bounds;
    ...
    /* Get parameters */
    alertPtr = MidpDisplayableFromId(KNI_GetParameterAsInt(1));
