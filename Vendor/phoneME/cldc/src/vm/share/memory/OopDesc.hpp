...
public:
  ...
  inline void map_native_oops_do(jubyte* map, void do_oop(OopDesc**));
  ...
  address_word* address_word_field_addr(int offset) const {
    return (address_word*)&((char*)this)[offset];
  }
