...
class Thread: public Oop {
 public:
  ...
  address last_java_sp() const {
    return (address)address_word_field(last_java_sp_offset());
  }
  void set_last_java_sp(address value) {
    address_word_field_put(last_java_sp_offset(), (address_word)value);
  }
  address last_java_fp() const {
    return (address)address_word_field(last_java_fp_offset());
  }
  void set_last_java_fp(address value) {
    address_word_field_put(last_java_fp_offset(), (address_word)value);
  }
  ...
  // Accessors for native stack pointers
  address stack_pointer() const {
    return (address)address_word_field(stack_pointer_offset());
  }

  void set_stack_pointer(address value) {
    address_word_field_put(stack_pointer_offset(), (address_word)value);
  }

  // Accessors for the stack limit
  address stack_limit() const {
    return (address)address_word_field(stack_limit_offset());
  }
