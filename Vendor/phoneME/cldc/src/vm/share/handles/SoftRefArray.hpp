...
class SoftRefArray: public Array {
 public:
  ...
  static unsigned get_counter ( const OopDesc* obj ) {
    return (unsigned)((uintptr_t)obj & CounterMask);
  }
  static OopDesc* get_value ( OopDesc* obj ) {
    return (OopDesc*) ((uintptr_t)obj & ValueMask);
  }
  static OopDesc* make ( OopDesc* obj, const unsigned counter ) {
    return (OopDesc*) ((uintptr_t)obj | counter);
  }
 ...
 private:
  ...
  static const uintptr_t CounterMask = 0x3;
  static const uintptr_t ValueMask = ~CounterMask;
 ...
 public:
  ...
  void obj_at_put(const int index, OopDesc* obj) {
    *obj_addr_at(index) =
        (OopDesc*)((uintptr_t)obj | (uintptr_t)max_counter());
  }
