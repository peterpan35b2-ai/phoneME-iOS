...
int32_t phoneme_platform_jit_status(void) {
    ...
    // UTM's TrollStore/HV build uses the same no-sandbox ptrace-child bootstrap.
    // Once the child was spawned successfully, generated code is allowed by the
    // TrollStore launch environment even before csops reflects the transition.
